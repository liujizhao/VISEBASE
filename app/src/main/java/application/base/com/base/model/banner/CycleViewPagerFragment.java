 ...
 */
@SuppressLint("NewApi")
public class CycleViewPagerFragment extends Fragment implements OnPageChangeListener {
    ...
    public static CycleViewPagerFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerFragmentLayout = view
                .findViewById(R.id.layout_viewpager_content);
    ...
    public void setData(List<ImageView> views, List<Banner> list, ImageCycleViewListener listener) {
     ...
     */
    private void setData(List<ImageView> views, List<Banner> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public void releaseHeight() {
        Objects.requireNonNull(getView()).getLayoutParams().height = RelativeLayout.LayoutParams.MATCH_PARENT;
        refreshData();
    }
    ...
    private void setIndicator(int selectedPosition) {
        for (ImageView indicator : indicators) {
            indicator
                    .setBackgroundResource(R.drawable.banner_normal_shape);
        }
        if (indicators.length > selectedPosition)
            indicators[selectedPosition]
                    .setBackgroundResource(R.drawable.banner_select_shape);
    }
    ...
    interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        void onImageClick(Banner info, int position, View imageView);
    }
